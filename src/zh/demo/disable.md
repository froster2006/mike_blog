...
**注：** 本项目托管于 [GitHub](https://github.com/Youchien/markdown-syntax)上，请通过 **Fork** 和 **Pull Request** 来帮忙改进本项目。
  ...
  [t]: https://twitter.com/bluetataZ
  [Github]: https://github.com/Youchien/markdown-syntax
...
如有更好的 Markdown 免费编辑器推荐或者有任何意见或者建议，请到[这里反馈](https://github.com/Youchien/markdown-syntax/issues)，谢谢！
